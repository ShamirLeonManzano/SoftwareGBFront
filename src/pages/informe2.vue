  ...
  <div>
    <v-card class="card" v-if="muestra == 0">
      ...
      >
        <template v-slot:top>
          <v-toolbar flat>
            <v-toolbar-title>Informes Grupo Bíblico</v-toolbar-title>
    ...
    <div v-if="muestra == 1">
      ...
      <v-container>
        ...
        <v-row no-gutters>
          <v-col>
            <v-card class="pa-1" outlined>
              <strong>Felipe Grupo: </strong>
              <span class="blue--text" v-if="detalle.fGrupo == 1">
                Asistió
              </span>
              <span class="red--text" v-if="detalle.fGrupo == 0"
                >No Asistió
              </span>
              <br />
            </v-card>
          ...
          <v-col>
            <v-card class="pa-1" outlined>
              <strong>Felipe Ayudante: </strong>
              <span class="blue--text" v-if="detalle.fAyudante == 1">
                Asistió
              </span>
              <span class="red--text" v-if="detalle.fAyudante == 0"
                >No Asistió
              </span>
            </v-card>
          </v-col>
          <v-col>
            <v-card class="pa-1" outlined>
              <strong>Felipe Maestro: </strong>
              <span class="blue--text" v-if="detalle.fMaestro == 1">
                Asistió
              </span>
              <span class="red--text" v-if="detalle.fMaestro == 0"
                >No Asistió
              </span>
            </v-card>
          </v-col>
          <v-col>
            <v-card class="pa-1" outlined>
              <strong>Felipe Anfitrión: </strong>
              <span class="blue--text" v-if="detalle.fAnfitrion == 1">
                Asistió
              </span>
              <span class="red--text" v-if="detalle.fAnfitrion == 0"
                >No Asistió
              </span>
            </v-card>
          </v-col>
...
export default {
  ...
  methods: {
    ...
    checks(num) {
      if (num == 1) {
        // this.editedItem.fGrupo=this.checkFG
        if (this.checkFG == 1) {
          this.editedItem.fGrupo = 1;
          console.log(this.editedItem.fGrupo);
        } else {
        ...
        if (this.checkFA == 1) {
          this.editedItem.fAyudante = 1;
          console.log(this.editedItem.fAyudante);
        } else {
        ...
        if (this.checkFM == 1) {
          this.editedItem.fMaestro = 1;
          console.log(this.editedItem.fMaestro);
        } else {
        ...
        if (this.checkFAN == 1) {
          this.editedItem.fanfitrion = 1;
          console.log(this.editedItem.fanfitrion);
        } else {
    ...
    llegarId() {
      ...
      (this.idR = this.$store.state.idGb), console.log(this.idR);
    },
